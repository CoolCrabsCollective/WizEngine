...
bool pf::AStar::getPath(AStarNode* start, AStarNode* goal, std::vector<AStarNode*>& path)
{
...
void pf::AStar::pushOpen(AStarNode* node)
{
	open.push_back(node);
...
void pf::AStar::popOpen(AStarNode* node)
{
