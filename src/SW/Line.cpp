...
void Line::updateQuad()
{
	...
	m_quad[2].position = m_vertices[0].position + normalVector;
	m_quad[3].position = m_vertices[1].position + normalVector;
	...
	m_quad[2].texCoords = { m_textureRect.left, m_textureRect.top + m_textureRect.height };
	m_quad[3].texCoords = { m_textureRect.left + m_textureRect.width, m_textureRect.top + m_textureRect.height };
}
